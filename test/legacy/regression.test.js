...
function testDownloadFilenamesUseShanghaiTimestamp() {
  ...
  assert.ok(index.includes('client/ui/file-actions.js?v=1.2.67') && index.includes('client/app/image-actions-workflow.js?v=1.2.68') && index.includes('client/app/image-result-workflow.js?v=1.7.1-image-semantics') && index.includes('app.js?v=2.1.39-session-route-model') && index.includes('chatui.bundle.js?v=1.3.126-session-route-model'), 'browser cache versions should match the current static bundle');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.126-session-route-model'"), 'server bundle version should match browser cache-busting');
}
...
function testChatAnswerStreamingFlushesQuickly() {
  ...
  assert.ok(index.includes('chat-workflow.js?v=1.3.24-task-lifecycle-state-machine') && index.includes('chatui.bundle.js?v=1.3.126-session-route-model') && bundle.includes("BUNDLE_VERSION = '1.3.126-session-route-model'"), 'cache-busting versions should be bumped for streaming performance fixes');
}
...
function testEmptySessionEmbedsRouteDiagram() {
  ...
  assert.ok(index.includes('./app.js?v=2.1.39-session-route-model') && index.includes('flat-theme.css?v=2.1.88-content-region-dialogs'), 'embedded diagram assets should use updated cache versions');
...
function testHistoryAnchorLastQuestionSpacerClearsOnSubmit() {
  ...
  assert.ok(index.includes('history-anchor-nav.js?v=1.0.18') && index.includes('submit-workflow.js?v=1.2.88-session-route-model') && index.includes('chatui.bundle.js?v=1.3.126-session-route-model'), 'history spacer submit fix should bump browser cache versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.126-session-route-model'"), 'server bundle version should match the directory spacer fix cache-busting');
}
...
function testRegenerateSavesEarlyPendingSubmitBeforeRoute() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('regenerate-workflow.js?v=1.0.2-canonical-route-plan') && index.includes('app.js?v=2.1.39-session-route-model') && index.includes('chatui.bundle.js?v=1.3.126-session-route-model'), 'cache versions should deliver the canonical regenerate workflow');
}
...
function testReasoningCompletesBeforeAnswerStreaming() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('chat-workflow.js?v=1.3.24-task-lifecycle-state-machine') && index.includes('chatui.bundle.js?v=1.3.126-session-route-model'), 'chat stream reasoning-state fix should bump cache versions');
}
...
function testReasoningUnavailableWhenAnswerStartsWithoutReasoning() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('chat-workflow.js?v=1.3.24-task-lifecycle-state-machine') && index.includes('chatui.bundle.js?v=1.3.126-session-route-model'), 'empty-reasoning stream fix should bump cache versions');
}
...
function testReasoningMenuCloseReleasesFocusBeforeAriaHidden() {
  ...
  assert.ok(index.includes('reasoning-workflow.js?v=1.3.35-reasoning-persistence') && index.includes('composer.css?v=1.3.2-gpt5-reasoning-menu') && index.includes('chatui.bundle.js?v=1.3.126-session-route-model'), 'reasoning menu changes should bump cache versions');
}
...
function testCodeActionHoverAndHistoryAnchorActivePolish() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('styles/flat-theme.css?v=2.1.88-content-region-dialogs') && index.includes('assets/chatui.bundle.css?v=1.3.126-session-route-model'), 'CSS bundle cache versions should be bumped for visual fixes');
}
...
function testConfigBaseUrlDefault() {
  ...
  assert.ok(index.includes('config-workflow.js?v=1.2.74-route-follow-session'), 'config workflow changes should bump browser cache-busting version');
...
function testConfigCopyButtonsForBaseUrlAndApiKey() {
  ...
  assert.ok(index.includes('config-workflow.js?v=1.2.74-route-follow-session') && index.includes('bootstrap-workflow.js?v=2.1.0-preinsert-guard') && index.includes('styles/flat-theme.css?v=2.1.88-content-region-dialogs') && index.includes('app.js?v=2.1.39-session-route-model') && index.includes('chatui.bundle.js?v=1.3.126-session-route-model'), 'config copy UI changes should bump browser cache versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.126-session-route-model'"), 'server bundle version should match config copy cache-busting');
}
...
function testForceImageButtonOnUserMessages() {
  ...
  assert.ok(index.includes('message-workflow.js?v=1.3.39-image-quote') && index.includes('regenerate-workflow.js?v=1.0.2-canonical-route-plan') && index.includes('app.js?v=2.1.39-session-route-model') && index.includes('assets/chatui.bundle.css?v=1.3.126-session-route-model') && index.includes('chatui.bundle.js?v=1.3.126-session-route-model') && index.includes('styles/flat-theme.css?v=2.1.88-content-region-dialogs'), 'force-image UI and action changes should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.126-session-route-model'"), 'server bundle version should match force-image cache-busting');
}
...
function testImagePreviewWheelZoom() {
  ...
  assert.ok(index.includes('image-preview-workflow.js?v=1.2.67') && index.includes('chatui.bundle.js?v=1.3.126-session-route-model') && index.includes('styles/flat-theme.css?v=2.1.88-content-region-dialogs'), 'image preview zoom should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.126-session-route-model'"), 'server bundle version should match image preview zoom bundle cache-busting');
}
...
function testMessageActionButtonsUsePolishedStyle() {
  ...
  assert.ok(index.includes('assets/chatui.bundle.css?v=1.3.126-session-route-model') && index.includes('chatui.bundle.js?v=1.3.126-session-route-model') && index.includes('styles/flat-theme.css?v=2.1.88-content-region-dialogs'), 'message action visual polish should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.126-session-route-model'"), 'server bundle version should match message action polish cache-busting');
}
...
function testPendingFeedbackDoesNotWrapOnMobile() {
  ...
  assert.ok(index.includes('assets/chatui.bundle.css?v=1.3.126-session-route-model') && index.includes('chatui.bundle.js?v=1.3.126-session-route-model') && index.includes('styles/flat-theme.css?v=2.1.88-content-region-dialogs'), 'pending feedback mobile nowrap fix should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.126-session-route-model'"), 'server bundle version should match pending feedback cache-busting');
}
...
function testComposerWidthFollowsSidebarCollapsedMessageColumn() {
  ...
  assert.ok(index.includes('assets/chatui.bundle.css?v=1.3.126-session-route-model') && index.includes('chatui.bundle.js?v=1.3.126-session-route-model') && index.includes('styles/flat-theme.css?v=2.1.88-content-region-dialogs'), 'sidebar composer width fix should bump browser cache versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.126-session-route-model'"), 'server bundle version should match sidebar composer cache-busting');
}
...
function testRouteTimeoutShowsSlowNoticeThenFailsCleanly() {
  ...
  assert.ok(index.includes('submit-workflow.js?v=1.2.88-session-route-model') && index.includes('chat-workflow.js?v=1.3.24-task-lifecycle-state-machine') && index.includes('route-decision-workflow.js?v=2.0.1-session-route-model') && index.includes('app.js?v=2.1.39-session-route-model') && index.includes('flat-theme.css?v=2.1.88-content-region-dialogs'), 'cache versions should be bumped for route timeout UX');
}
