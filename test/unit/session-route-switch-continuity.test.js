...
function testSessionSwitchRecoveryRebindsWithoutDuplicateExecution() {
  ...
  assert.ok(index.includes('runs.js?v=1.2.66-session-run-owner') && index.includes('submit-workflow.js?v=1.2.88-session-route-model') && index.includes('app.js?v=2.1.43-welcome-height-adaptive') && index.includes('chatui.bundle.js?v=1.3.136-welcome-encoding-refresh'), 'browser cache versions must deliver the session-run ownership fix');
}
